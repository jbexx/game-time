...
function init() {
  ...
  //this is also where our aliens will be spawned at the start of game
}
...
function shoot() {
  var bullet = new Bullet(ship1.x + 6, 580, 1000);
...
function updateBulletArray() {
  bulletArray.forEach((bullet, index) => {
    if (bullet.x <= 0 || bullet.x >= game.width || bullet.y >= game.height || !bullet.active) {
