...
function collision(obstacle, bullet) {
  return bullet.x < obstacle.x +  obstacle.width && bullet.x + bullet.width > obstacle.x &&
...
function moveAliens() {
  ...
  if (shipArray.length !== 0) {
    alienArray.forEach( alien => {
      ...
      if (alienCounter === 60 && alien.spriteX === 32) {
        alien.spriteX = 10
      } else if (alienCounter === 60 && alien.spriteX === 10) {
        alien.spriteX = 32
      }
