...
function shoot() {
  var bullet = new Bullet(ship1.x + 6, 550);
...
function alienFire() {
  ...
  if (ranNum > 0.995) {
    // console.log(ranNum);
        var alienBullet = new Bullet(alienArray.forEach( alien => {
          alien.y + alien.height + 1
        }),
      171);
        bulletArray.push(alienBullet);
      }
